...
require("grid-template-columns: minmax(0, 1fr);" in css, "Home map backdrop does not span the content width")
require(".server-card__map::after" in css and "object-fit: cover;" in css, "Home map backdrop or dark overlay is missing")
require("min-height: 76px;" in css and "min-height: 70px;" in css, "Home map backdrop is not compact and responsive")
...
require("server-card__scoreboard-team--allies" in main_js and "server-card__scoreboard-team--axis" in main_js, "Scores are not attached to their team labels")
